...
import com.zan.webviewdemo.webbase.Provider;
...
public class ExecutorProvider implements Provider<Executor> {
    ...
    private final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            ...
            ZanL.i(TAG, "Thread Name:" + mThread.getName());
            ZanL.i(TAG, "live:" + mThreadPoolExecutor.getActiveCount() + "    getCorePoolSize:" + mThreadPoolExecutor.getCorePoolSize() + "  getPoolSize:" + mThreadPoolExecutor.getPoolSize());
            return mThread;
        }
    };
