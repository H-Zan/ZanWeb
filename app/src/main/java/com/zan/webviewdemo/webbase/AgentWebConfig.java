...
public class AgentWebConfig {
	...
	static final String FILE_CACHE_PATH = "aceweb-cache";
	static final String AGENTWEB_CACHE_PATCH = File.separator + "aceweb-cache";
	/**
	 * 缓存路径
	 */
	 ...
	 * AgentWeb 的版本
	 */
	public static final String AGENTWEB_VERSION = " AceTeam/1.0.2 ";

	public static final String AGENTWEB_NAME="AceWeb";
	/**
	...
	private static ValueCallback<Boolean> getDefaultIgnoreCallback() {
		return new ValueCallback<Boolean>() {
			...
			public void onReceiveValue(Boolean ignore) {
				ZanL.i(TAG, "removeExpiredCookies:" + ignore);
			}
		};
	}
}
