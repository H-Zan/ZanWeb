...
public class WebIndicator extends BaseIndicatorView implements BaseIndicatorSpec {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        WEB_INDICATOR_DEFAULT_HEIGHT = Utils.dp2px(context, 3);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        ZanL.i("WebProgress", "CURRENT_MAX_UNIFORM_SPEED_DURATION" + CURRENT_MAX_UNIFORM_SPEED_DURATION);
    }
    ...
    private void startAnim(boolean isFinished) {
        ...
        ZanL.i("WebIndicator", "mCurrentProgress:" + mCurrentProgress + " v:" + v + "  :" + (1f - mCurrentProgress));
        if (!isFinished) {
